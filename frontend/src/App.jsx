...
import {
  ...
  FiPlus, FiSearch, FiSettings, FiShield, FiSparkles, FiTarget, FiTrendingUp,
  FiUploadCloud, FiUser, FiX, FiZap
} from "react-icons/fi";

const navItems = [
  ["Dashboard", FiHome], ["My Resumes", FiFileText], ["ATS Score", FiActivity],
  ["AI Analyzer", FiSparkles], ["Templates", FiLayers], ["Cover Letter", FiEdit3],
    ...
    <div className="app-shell">
      <aside className={`sidebar ${mobileNav ? "open" : ""}`}>
        ...
        <div className="upgrade-card">
          <div className="upgrade-icon"><FiSparkles /></div>
...
function Dashboard({ setPage, score, scoreLabel, skills, missing, suggestions, file, setFile, loading, uploadResume, inputRef, onFile }) {
  return <div className="page-wrap fade-in">
    ...
    <section className="quick-tools"><button onClick={() => setPage("ATS Score")}><FiShield /><span>ATS Score Checker</span><FiArrowRight /></button><button onClick={() => setPage("AI Analyzer")}><FiSparkles /><span>AI Suggestions</span><FiArrowRight /></button><button onClick={() => setPage("Job Matcher")}><FiTarget /><span>Job Match Analysis</span><FiArrowRight /></button></section>
